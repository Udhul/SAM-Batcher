# image_predictor_example 
# Sections from the NOTEBOOK converted to python script

# Object masks in images from prompts with SAM 2
# Segment Anything Model 2 (SAM 2) predicts object masks given prompts that indicate the desired object. 
# The model first converts the image into an image embedding that allows high quality masks to be efficiently produced from a prompt.

# The SAM2ImagePredictor class provides an easy interface to the model for prompting the model. 
# It allows the user to first set an image using the set_image method, which calculates the necessary image embeddings. 
...
# Set seed for random number generators on colors
np.random.seed(3)
...
# Example image
image = Image.open('Modules/sam2/notebooks/images/truck.jpg')
...
sam2_checkpoint = "Modules/sam2/checkpoints/sam2.1_hiera_base_plus.pt"
...
# image2 = Image.open('Modules/sam2/notebooks/images/groceries.jpg')
